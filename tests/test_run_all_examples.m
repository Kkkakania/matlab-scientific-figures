...
function testRunAllExamplesCreatesTwentyOnePngFiles(testCase)
...
verifyEqual(testCase, numel(result), 21);
verifyEqual(testCase, numel(pngFiles), 21);
...
verifyEqual(testCase, height(report), 21);
