...
function testRunAllExamplesCreatesTwentyPngFiles(testCase)
...
verifyEqual(testCase, numel(result), 20);
verifyEqual(testCase, numel(pngFiles), 20);
...
verifyEqual(testCase, height(report), 20);
