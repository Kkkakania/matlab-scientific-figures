...
function testRunAllExamplesCreatesNineteenPngFiles(testCase)
...
verifyEqual(testCase, numel(result), 19);
verifyEqual(testCase, numel(pngFiles), 19);
...
verifyEqual(testCase, height(report), 19);
