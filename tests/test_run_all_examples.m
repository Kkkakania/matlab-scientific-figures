...
function testRunAllExamplesCreatesTwentyFivePngFiles(testCase)
...
verifyEqual(testCase, numel(result), 25);
verifyEqual(testCase, numel(pngFiles), 25);
...
verifyEqual(testCase, height(report), 25);
