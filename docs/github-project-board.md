...
| [`matlab-figure-ci#1`](https://github.com/Kkkakania/matlab-figure-ci/issues/1) | `enhancement`, `ci` |
...
`agent` for MATLAB, Python, or diagram Skills, `ci` for `matlab-figure-ci`, and
