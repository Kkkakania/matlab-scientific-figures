...
- Keep `v3.4.0` as the current public release until a user-visible reason
  justifies another tag.
- Use patch releases, such as `v3.4.1`, for documentation fixes, CI checks,
  typo fixes, and small maintenance work.
- Use minor releases, such as `v3.5.0`, only when users get a new workflow,
