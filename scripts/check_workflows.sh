...
require_text "$FIGURE_WORKFLOW" "actions/checkout@"
require_text "$FIGURE_WORKFLOW" "actions/setup-python@"
require_text "$FIGURE_WORKFLOW" "actions/upload-artifact@"
...
reject_text "$FIGURE_WORKFLOW" "actions/checkout@v5"
reject_text "$FIGURE_WORKFLOW" "actions/setup-python@v4"
reject_text "$FIGURE_WORKFLOW" "actions/setup-python@v5"
reject_text "$FIGURE_WORKFLOW" "actions/upload-artifact@v4"

require_text "$QUALITY_WORKFLOW" "actions/checkout@"
...
reject_text "$QUALITY_WORKFLOW" "actions/checkout@v5"
...
require_text "$TRIAGE_WORKFLOW" "run_gh()"
require_text "$TRIAGE_WORKFLOW" "max_attempts=3"
require_text "$TRIAGE_WORKFLOW" "HTTP 5"
