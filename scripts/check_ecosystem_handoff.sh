...
require_text "$DOC" "scientific-diagram-skill/issues/new?template=diagram_feedback.md"
require_text "$DOC" "python-plotting-skill"
require_text "$DOC" "docs/gallery/*.png and docs/gallery/*.svg"
require_text "$DOC" "python-plotting-skill/issues/new?template=first-use-feedback.yml"
require_text "$DOC" "matlab-scientific-figures/issues/new?template=first_use_feedback.md"
require_text "$DOC" "matlab-plotting-skill/issues/new?template=first_use_feedback.yml"
