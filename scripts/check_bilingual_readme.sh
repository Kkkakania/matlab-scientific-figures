...
grep -Fq "python-plotting-skill" "$README"
grep -Fq "python-plotting-skill" "$README_ZH"
grep -Fq "scientific-diagram-skill" "$README"
grep -Fq "scientific-diagram-skill" "$README_ZH"
grep -Fq "draw.io" "$README"
grep -Fq "draw.io" "$README_ZH"
grep -Fq "small sibling project" "$README"
grep -Fq "早期仓库" "$README_ZH"
