...
require_text "Snapshot date: 2026-07-15"
require_text "not a promise of Claude for Open Source eligibility"
...
require_text "d01a86c"
require_text "29073068893"
require_text "29073068866"
...
require_text "f3ba856"
require_text "29096995948"
require_text "29096996024"
require_text "1f82b1d"
require_text "29387457191"
...
require_text "b48540e"
require_text "29386480417"
require_text "contribution/security/conduct entrypoints"
require_text "README badge checks"
require_text "issue triage checklist"
require_text "first-use issue"
require_text "72e569e"
require_text "29387445582"
require_text "README template-count guard"
require_text "20-template"
...
require_text "./scripts/check_application_live_snapshot.sh"
require_text "The live snapshot checks both main-repository workflows"
...
if [[ ! -x "$ROOT_DIR/scripts/check_application_live_snapshot.sh" ]]; then
  echo "generic application live snapshot helper is missing or not executable" >&2
  exit 1
fi
...
reject_text "2026-06-27"
reject_text "15-template"
reject_text "4f064fa"
reject_text "27937231749"
reject_text "27937231695"
reject_text "5dfe425"
reject_text "27937069270"
reject_text "519efa7"
reject_text "27940671971"
reject_text "8292dd2"
reject_text "27937426099"
reject_text "a28131f"
