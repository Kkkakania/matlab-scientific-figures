...
grep -Fq './scripts/render_all.sh harmonic-spectrum' "$SCRIPT"
...
grep -Fq 'renderHarmonicSpectrum(' "$SCRIPT"
grep -Fq 'renderDirectionalRose(' "$SCRIPT"
grep -Fq 'renderMarginalScatter(' "$SCRIPT"
grep -Fq 'renderRaincloudDistribution(' "$SCRIPT"
grep -Fq 'renderRibbonComparison(' "$SCRIPT"
grep -Fq 'renderVectorField(' "$SCRIPT"
grep -Fq 'renderPolarBubble(' "$SCRIPT"
grep -Fq 'sftRenderDataFile(' "$SCRIPT"
